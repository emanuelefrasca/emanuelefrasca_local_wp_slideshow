		...
		<div class="parallax-section">	
			...
			<div class="container z-index-pages">
				<div class="sixteen columns">
					<h1><?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'ananke' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'ananke' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'ananke' ) ) );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'ananke' ), get_the_date( _x( 'Y', 'yearly archives date format', 'ananke' ) ) );
