...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments"><?php _e('This post is password protected. Enter the password to view comments.', 'cosmone'); ?></p> 
	<?php
		return;
	}
?>
...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number(__('No comment', 'cosmone'), __('Has one comment', 'cosmone'), __('% comments', 'cosmone'));?> <?php printf(__('to &#8220;%s&#8221;', 'cosmone'), the_title('', '', false)); ?></h3>
<div class="upcomment"><?php _e('You can ','cosmone'); ?><a id="leaverepond" href="#comments"><?php _e('leave a reply','cosmone'); ?></a>  <?php _e(' or ','cosmone'); ?> <a href="<?php trackback_url(true); ?>" rel="trackback"><?php _e('Trackback','cosmone'); ?></a> <?php _e('this post.','cosmone'); ?></div>
	<ol id="thecomments" class="commentlist comments-list">
	<?php wp_list_comments('type=comment&callback=cosmone_comment');?>
	</ol>
...
?>
		<div id="commentnavi">
			<span class="pages"><?php _e('Comment pages', 'cosmone'); ?></span>
			<div id="commentpager">
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ( comments_open() ) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments"><?php //_e('Comments are closed.', 'cosmone'); ?></p>
...
<p><?php printf(__('You must be <a href="%s">logged in</a> to post a comment.', 'cosmone'), wp_login_url( get_permalink() )); ?></p>
<?php else : ?>
<?php 
...
'class_submit'         => 'submitss',
    ...
    __( 'Your email address will not be published.', 'cosmone' ) . ( $req ? $required_text : '' ) .
    '</p>',
        // change the title of the reply section
        'title_reply'=>__('Write a Reply or Comment', 'cosmone'),
